...
List<DetailResp> detailRespFromJson(String str) =>
    List<DetailResp>.from(json.decode(str).map((x) => DetailResp.fromJson(x)));

String detailRespToJson(List<DetailResp> data) =>
